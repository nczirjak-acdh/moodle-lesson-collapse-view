...
class mod_lesson_renderer extends plugin_renderer_base {
    ...
    /*
     * Returns Expanded View in HTML to display a page to the user
     * @param lesson $lesson
     * @param $pageid
     * @param $prevpageid
     * @param $single
     ...
     * @return string
     * 
     * 18.10.2016 - Norbert Czirjak - Lesson expanded view
     */
    public function display_page_full(lesson $lesson, $pageid, $prevpageid, $single=false, lesson_page $page, $attempt) {
        global $DB, $CFG;
        ...
        while ($pageid != 0 && $single!=='stop') {
            ...
            /* generating the lesson sections */
            ob_start();
            echo $page->display($this, $attempt);
            ...
            $pagetable->data[] = new html_table_row(array($pageContent));
        ...
        //return $this->output->box($content, 'view_pages_box');
        return $this->output->box($content, 'view_pages_box');
    }
